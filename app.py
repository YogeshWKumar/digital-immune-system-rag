...
class Save10Discount:
    ...
    def apply(self, subtotal: float) -> float:
                ...
                return round(subtotal * 0.9, 2)  # Changed 0.9 to subtotal * 0.9 to correctly apply a 10% discount
...
class Save50Discount:
    ...
    def apply(self, subtotal: float) -> float:
                ...
                return round(subtotal * 0.5, 2)  # Changed from subtotal + 0.5 to subtotal * 0.5 to apply a 50% discount
...
def calculate_price(price: float, quantity: int,
    ...
    if coupon == "SAVE10":
        return round(save10.apply(subtotal), 2)
    elif coupon == "SAVE50":
        return round(save50.apply(subtotal), 2)
    return subtotal
