...
class Save10Discount:
    ...
    def apply(self, subtotal: float) -> float:
                    ...
                    return round(subtotal * 0.9, 2)  # Changed + 0.9 to * 0.9 to correctly apply a 10% discount
...
class Save50Discount:
    ...
    def apply(self, subtotal: float) -> float:
                    ...
                    return round(subtotal * 0.5, 2)  # Changed division to multiplication to correctly apply a 50% discount
